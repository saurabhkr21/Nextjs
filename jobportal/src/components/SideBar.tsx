...
export default function SideBar() {
  ...
  const categories = [
    { name: "Business", count: 25730, icon: "💼", color: "bg-blue-50 border-blue-200 text-blue-700" },
    { name: "Other", count: 11821, icon: "📦", color: "bg-gray-50 border-gray-200 text-gray-700" },
    { name: "Advertising", count: 4251, icon: "📢", color: "bg-green-50 border-green-200 text-green-700" },
    { name: "Data", count: 3750, icon: "📊", color: "bg-purple-50 border-purple-200 text-purple-700" },
    { name: "Tools", count: 3603, icon: "🛠️", color: "bg-orange-50 border-orange-200 text-orange-700" },
    { name: "Artificial Intelligence/Machine Learning", count: 3097, icon: "🤖", color: "bg-pink-50 border-pink-200 text-pink-700" }
  ];
  ...
  return (
    <div className="flex flex-col w-[280px] bg-gradient-to-b from-white to-blue-50 shadow-xl border-r border-blue-100 h-screen overflow-y-auto">
      {/* Header Section */}
      ...
      <div className="p-4 border-b border-blue-100">
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-3">
          <h3 className="text-sm font-semibold text-blue-800 mb-2">📈 Total APIs</h3>
                ...
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <p className={`
                      ...
                      ${selectedCategory === category.name ? 'text-current' : 'text-gray-700 group-hover:text-gray-900'}
                    `}>
                      {category.name}
                    </p>
                    {category.name === "Artificial Intelligence/Machine Learning" && (
